...
;
/**
 * Get Web resource via a fetch. There is a sanity (security) check on the URL using [[check_url]] to avoid possible security errors.
 *
 * @async
 ...
 */
function fetch_resource(resource_url, format) {
...
function fetch_html(html_url) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const body = yield fetch_resource(html_url, ContentType.html);
...
function fetch_json(json_url) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const body = yield fetch_resource(json_url, ContentType.json);
            return body;
        }
        catch (err) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (ref[0] === '#') {
                ...
                try {
                    text = yield fetch_json(link.href);
                    base = link.href;
                }
                catch (err) {
